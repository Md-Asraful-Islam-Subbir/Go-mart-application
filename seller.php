...
<header>
    ...
    <nav  class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <span style="color:blue"> <?php echo $_SESSION['name'] ?></span><span></span>
    </nav>
...
<!-- Login sesh -->
  ...
  <div style="margin: 2rem 0rem 0rem 2rem; width:65%; " id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
